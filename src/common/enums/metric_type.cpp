...
profiler_settings_t MetricsUtils::GetOptimizerMetrics() {
    return {
        ...
        MetricsType::OPTIMIZER_FACTORIZATION,
    };
}
...
MetricsType MetricsUtils::GetOptimizerMetricByType(OptimizerType type) {
    switch(type) {
        ...
        case OptimizerType::FACTORIZATION:
            return MetricsType::OPTIMIZER_FACTORIZATION;
       default:
...
OptimizerType MetricsUtils::GetOptimizerTypeByMetric(MetricsType type) {
    switch(type) {
        ...
        case MetricsType::OPTIMIZER_FACTORIZATION:
            return OptimizerType::FACTORIZATION;
    default:
