...
LogicalType LogicalType::FACT_POINTER(vector<LogicalType> &children, vector<ColumnBinding> &bindings, idx_t emitter_id) {
	auto info = make_shared<FactPointerTypeInfo>(children, bindings, emitter_id);
